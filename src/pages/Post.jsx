...
const Article = () => {
  ...
  const handleLike = () => {
    axios.post(`https://print-gurus-jmfg.onrender.com/like-post/${post.id}/`)
      .then(res => {
  ...
  return (
    ...
    <Box sx={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)), url('/images/background.jpg')`,
